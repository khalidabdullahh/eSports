        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
          ...
          <div className="w-full lg:w-80 p-5 rounded-xl bg-surface-200 border border-surface-border space-y-4 shrink-0">
            <div className="flex justify-between items-baseline">
              <span className="text-xs text-gray-400 font-mono uppercase">Entry Fee</span>
              ...
              {userRegistration ? (
                <div className="space-y-2">
                  ...
                  <Link
                    ...
                    className="w-full py-2.5 rounded-lg bg-cyan-500 hover:bg-cyan-400 text-black font-semibold text-xs uppercase tracking-wider flex items-center justify-center gap-2 transition-all"
                  >
                ...
                <Link
                  href="/live"
                  className="w-full py-3 rounded-lg bg-red-600 hover:bg-red-500 text-white font-semibold text-xs uppercase tracking-wider flex items-center justify-center gap-2 shadow-lg shadow-red-600/30 transition-all"
                >
                ...
                >
                  Tournament Slots Full
                </button>
              ) : (
                <Link
                  href={`/tournaments/${tournament.id}/register`}
                  className="w-full py-3 rounded-lg bg-cyan-500 hover:bg-cyan-400 text-black font-bold text-sm uppercase tracking-wider flex items-center justify-center gap-2 shadow-lg shadow-cyan-500/25 transition-all"
                >
                  <Trophy className="w-4 h-4" />
                  Register Now ({formatCurrency(tournament.entry_fee_cents, tournament.currency)})
                </Link>
              )}

              <Link
                href="/dashboard"
                className="w-full py-2 rounded-lg bg-surface-elevated hover:bg-surface-50 text-gray-300 text-xs font-medium flex items-center justify-center transition-colors"
              >
        ...
        <div className="lg:col-span-8 space-y-8">
          ...
          <div className="rounded-xl bg-surface-100 border border-surface-border p-6 space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 pb-4 border-b border-surface-border">
              ...
              <span className="font-display text-2xl font-black text-amber-400">
                {formatCurrency(totalPrizeCents, tournament.currency)}
              </span>
            </div>
          ...
          <div className="rounded-xl bg-surface-100 border border-surface-border p-6 space-y-4">
            ...
            <p className="text-xs text-gray-400">
              ...
              <code className="text-cyan-300 bg-surface-200 px-1.5 py-0.5 rounded">
